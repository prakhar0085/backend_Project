...
router.post("/upload", checkAuth, async (req, res) => {
  try {
    ...
    // vedio document creation
    const newVideo = new Video({
      _id: new mongoose.Types.ObjectId(),
      title,
      description,
      user_id: req.user._id,     // Associates video with the user who uploaded it  // req.user was added by checkAuth middleware

      videoUrl: videoUpload.secure_url,       //videoUrl: The HTTPS link to stream/download the video
      videoId: videoUpload.public_id,         //videoId: Cloudinary's unique identifier Needed later if you want to delete/update the video in Cloudinary
